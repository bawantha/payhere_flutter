...
//      m['itemsDescription'] = getItemsDescription() ??
//          ArgumentError("itemsDescription is required");
//      m['custom1'] = getCustom1() ?? ArgumentError("custom1 is required");
//      m['custom2'] = getCustom2() ?? ArgumentError("custom2 is required");
//      m['firstName'] = getCustomer().getFirstName() ??
//          ArgumentError("firstName is required");
//      m['lastName'] =
//          getCustomer().getLastName() ?? ArgumentError("lastName is required");
//      m['email'] =
//          getCustomer().getEmail() ?? ArgumentError("email is required");
//      m['phone'] =
//          getCustomer().getPhone() ?? ArgumentError("phone is required");
...
//      //Optional Params
//      m['deliveryAddress'] =
//          getCustomer().getDeliveryAddress().address ?? "N/A";
//      m['deliveryAddressCity'] =
//          getCustomer().getDeliveryAddress().city ?? "N/A";
//      m['deliveryAddressCountry'] =
//          getCustomer().getDeliveryAddress().country ?? "N/A";
//      m['setStartupFee'] = getStartupFee() ?? "N/A";
//    } catch (e) {
//      print(e.toString());
//    }
//
